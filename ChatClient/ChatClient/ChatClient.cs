        ...
        private static void ReceiveCallback(IAsyncResult ar)
        {
            try
            {
                ...
                if (bytesRead > 0)
                {
                    ...
                    state.ReceivedDataString.Append(Encoding.ASCII.GetString(state.buffer, 0, bytesRead));
                ...
                else
                {
                    ...
                    if (state.ReceivedDataString.Length > 1)
                    {
                        response = state.ReceivedDataString.ToString();
                    }
